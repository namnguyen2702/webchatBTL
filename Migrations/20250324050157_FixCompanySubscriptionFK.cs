...
{
    /// <inheritdoc />
    public partial class FixCompanySubscriptionFK : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Subscrip__755C22B72F8DDC56", x => x.PlanId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__CompanyS__2D971CAC674DEA60", x => x.CompanyId);
                    table.ForeignKey(
                        name: "FK__CompanySe__Compa__45F365D3",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Invoices__Compan__4E88ABD4",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "CompanyId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanySubscription_Company",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "CompanyId");
                    table.ForeignKey(
                        name: "FK_CompanySubscription_SubscriptionPlan",
                        column: x => x.PlanId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__GroupInC__149AF36A886E463B", x => x.GroupId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_GroupInCompany",
                        column: x => x.GroupId,
                        principalTable: "GroupInCompany",
                        principalColumn: "GroupId");
                    table.ForeignKey(
                        name: "FK__Users__CompanyId__71D1E811",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "CompanyId");
                    table.ForeignKey(
                        name: "FK__Users__RoleId__72C60C4A",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Groups__CreatedB__0C85DE4D",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Messages__Receiv__07C12930",
                        column: x => x.ReceiverId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                    table.ForeignKey(
                        name: "FK__Messages__Sender__06CD04F7",
                        column: x => x.SenderId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Participa__Event__55F4C372",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "EventId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK__Participa__UserI__56E8E7AB",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Projects__Compan__7A672E12",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "CompanyId");
                    table.ForeignKey(
                        name: "FK__Projects__Create__7B5B524B",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__UserSess__C9F49290BE3DC733", x => x.SessionId);
                    table.ForeignKey(
                        name: "FK__UserSessi__UserI__1F98B2C1",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__GroupMem__C5E27FAE4B4736D3", x => new { x.GroupId, x.UserId });
                    table.ForeignKey(
                        name: "FK__GroupMemb__Group__10566F31",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "GroupId");
                    table.ForeignKey(
                        name: "FK__GroupMemb__UserI__114A936A",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Tasks__AssignedT__01142BA1",
                        column: x => x.AssignedTo,
                        principalTable: "Users",
                        principalColumn: "UserId");
                    table.ForeignKey(
                        name: "FK__Tasks__ProjectId__00200768",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupInCompany_ManagerId",
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Users__A9D10534058B5E5C",
                table: "Users",
                column: "Email",
                unique: true);
            ...
            migrationBuilder.AddForeignKey(
                name: "FK__Events__GroupId__44CA3770",
                table: "Events",
                column: "GroupId",
                principalTable: "GroupInCompany",
                principalColumn: "GroupId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK__Events__UserId__43D61337",
                table: "Events",
                column: "UserId",
                principalTable: "Users",
                principalColumn: "UserId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK__Files__MessageId__17F790F9",
                table: "Files",
                column: "MessageId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK__Files__ProjectId__17036CC0",
                table: "Files",
                column: "ProjectId",
                principalTable: "Projects",
                principalColumn: "ProjectId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK__Files__UploadedB__151B244E",
                table: "Files",
                column: "UploadedBy",
                principalTable: "Users",
                principalColumn: "UserId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK__GroupInCo__Manag__40F9A68C",
                table: "GroupInCompany",
                column: "ManagerId",
                principalTable: "Users",
                principalColumn: "UserId",
